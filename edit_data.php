...
<body>
            ...
            <div class="col-sm-12">
                ...
                ?>
                    <div class="col-md-3" style="float: left;">
                      <div class="thumbnail">
                          <img src="images/<?php echo $kategori.'/'.$row['nama'] ?>" alt="Lights" style="width:100%">
                          <div class="caption">
                            <br>
                            <p><a class='btn btn-danger' href='proses.php?p=hapus_foto&&id=$id'>Hapus</a></p>
                          </div>
                      </div>
                    </div>
                <?php
    ...
    <script>
        ...
        $("#kategori").val("<?php echo $items['kategori']; ?>").attr('selected','selected');
