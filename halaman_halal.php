...
<body>
    ...
    <div class="wrapper container my-2">
        <div class="row">
            <div class="col-sm-12">
                            <a href="tambah_data.php?kategori=halal" class="btn btn-primary float-right">Tambah Data Kuliner Halal</a>
                            <br><br>
                    ...
                    <tbody>
                            <?php
                                $query=mysqli_query($conn,"SELECT * FROM lokasi WHERE kategori = 'halal'");
                            ...
                            <td>$lat</td>
                            <td>$lng</td>
                            <td><a class='btn btn-warning' href='edit_data.php?id=$id'>Ubah</a> <a class='btn btn-danger' href='proses.php?p=hapus_lokasi&&id=$id'>Hapus</a></td>
                            </tr>";
                                }
                            ?>
                    </tbody>
